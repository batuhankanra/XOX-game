...
function chooseArea(block){
    if(block.textContent===""){
        ...
        errorText.textContent="heyy it is not empty"
...
function turnPlayer(){
    if(player==="X"){
        player="O";
        playerText.textContent=`${player} is turn !`
    }else if(player==="O"){
        player="X";
        playerText.textContent=`${player} is turn !`
    }
...
function checkDiagonals(){
    let dia1=blocks[2].textContent==blocks[4].textContent && 
    blocks[2].textContent== blocks[6].textContent &&
    blocks[2].textContent !==""
    let dia2=blocks[0].textContent==blocks[4].textContent && 
